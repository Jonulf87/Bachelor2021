...
const SeatMapProvider = ({ children }) => {
    ...
    return <SeatMapContext.Provider value={{ setRows, getSeatMap, rows, error, gridSize, numberOfSeats, rowName, setNumberOfSeats, setRowName, ticketTypes, rowNameAlreadyExists, submitRows, addRow, updateRowPosition, updateRowData }}>{children}</SeatMapContext.Provider>;
