        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketDescriptionName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TicketBasePrice = table.Column<int>(type: "int", nullable: false),
                    TicketAmountAvailable = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueAreaAvailable = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserApplicationUser_MinorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainEvents_OrganizerId",
                table: "MainEvents",
                column: "OrganizerId");
