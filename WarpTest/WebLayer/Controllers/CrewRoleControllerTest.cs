...
namespace WarpTest.WebLayer.Controllers
{
    class CrewRoleControllerTest : BaseTest
    {
        ...
        //    Assert.AreEqual("Test Rolle 1", returnedCrewRole1.IsLeader);
        ...
        //    Assert.AreEqual("Test Rolle 2", returnedCrewRole2.IsLeader);
        ...
        //    Assert.AreEqual(_descr, createdCrewRole.IsLeader);
        //    Assert.IsNull(createdCrewRole.Crews);

        //    // Check what we really have in the DB
        //    CrewUser crewRole1 = _dbContext.CrewRoles.Find(4);
        //    Assert.AreEqual(4, crewRole1.Id);
        ...
        //    CrewUser crewRole1 = _dbContext.CrewRoles.Find(1);
        //    Assert.AreEqual(_descr, crewRole1.Description);

        //    CrewUser crewRole2 = _dbContext.CrewRoles.Find(2);
        ...
        //    CrewUser crewRole3 = _dbContext.CrewRoles.Find(3);
